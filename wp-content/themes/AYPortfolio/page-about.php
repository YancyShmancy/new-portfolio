    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-8">
                ...
                <p>After a long career as an unpaid family internet expert, I decided it might be nice to start actually getting paid for my expertise. In 2016 I graduated from the <a href="https://creativecircus.edu" target="_blank">Creative Circus</a> two year web development program. Since then I have been working as a (paid) full stack developer for marketing agencies and dev firms.</p>
